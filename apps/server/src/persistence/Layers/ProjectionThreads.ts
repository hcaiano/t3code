...
import { ModelSelection, ThreadPairSession, ThreadPairState } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.pairSession == null ? null : JSON.stringify(row.pairSession)},
          ${row.pairState == null ? null : JSON.stringify(row.pairState)},
        ...
        DO UPDATE SET
          ...
          pair_session_json = excluded.pair_session_json,
          pair_state_json = excluded.pair_state_json,
