...
import {
  ...
  type StartThreadPairInput,
  type EndThreadPairInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    startPair: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:start-pair",
      execute: (input: StartThreadPairInput) => startThreadPair(input),
      scheduler,
      concurrency,
    }),
    endPair: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:end-pair",
      execute: (input: EndThreadPairInput) => endThreadPair(input),
      scheduler,
      concurrency,
    }),
